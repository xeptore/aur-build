...
source_x86_64="https://github.com/docker/docker-credential-helpers/releases/download/v${VERSION_NUMBER}/docker-credential-pass-v${VERSION_NUMBER}.linux-amd64"
license_file_url="https://raw.githubusercontent.com/docker/docker-credential-helpers/v${VERSION_NUMBER}/LICENSE"

wget -q "https://github.com/docker/docker-credential-helpers/releases/download/v${VERSION_NUMBER}/checksums.txt" -O checksums.txt
wget -q "$license_file_url" -O LICENSE

sha256sums_x86_64="$(grep "docker-credential-pass-v${VERSION_NUMBER}.linux-amd64" checksums.txt | cut -d ' ' -f 1)"
...
source_x86_64=(
  'docker-credential-pass-v${VERSION_NUMBER}.linux-amd64::${source_x86_64}'
